...
.curso-main-container.pb-3
  ...
  .container.tarjeta.tarjeta--blanca.p-4.p-md-5.mb-5
    ...
    p.mb-4 Otros autores definen el #[em merchandising] de la siguiente forma:
      ...
      .col-sm-12.col-lg-4.col-md-12.mb-4(data-aos="fade-right")
        .overflow-hidden.h-100.p-2
          .row.align-items-center.justify-content-center.bgfondotema1.p-1
            ...
            p.text-center.p-4.mb-5 “El #[em marketing] evoluciona para estimular la intención de compra (el merchandising) para provocar el deseo de poseer o consumir el producto a través de un escenario con una atmósfera adaptada a la mente del consumidor” (Palomares, 2009).
    ...
    .row.justify-content-center.align-items-center
      ...
      .col-lg-8.col-sm-12.col-md-12
        .cajon.color-acento-contenido.p-5.mb-5
          p Combinando las dos clasificaciones anteriores, clases de #[em merchandising] y clases de productos, deben tenerse en cuenta los siguientes factores:
        ul.lista-ul--color.fa-al
            li.mb-0 
              i.fas.fa-check-circle
              span.mb-4 #[b La manipulación de los productos:] si el producto es pesado, debe colocarse en un lugar que privilegie la comodidad para seleccionarlo y transportarlo, así mismo, almacenarlo en el punto de venta.
            li.mb-0 
              i.fas.fa-check-circle
              span.mb-4 #[b La conservación de los productos:] si el producto debe permanecer refrigerado, congelado, a temperatura ambiente o con higienización especial.
        p Finalmente, es importante ponerlos en un espacio que facilite el surtido y la rotación.

    separador
    #t_1_1.titulo-segundo.mb-4
      h2 1.2 Tipos de #[em merchandising]

    p.mb-4 Ahora bien, adicional a las clases, se pueden identificar dos tipos principales de #[em merchandising], el visual y el de gestión. A continuación, se describen cada uno de estos tipos con mayor detalle:

    .subt.mb-4(data-aos="fade-right")
      .d-flex.align-items-center.mb-1
        img(src='@/assets/curso/temas/icono.svg', alt='')
        h3.mb-0.ms-2 #[em Merchandising] visual
    ...
    .subt.mb-4(data-aos="fade-right")
      .d-flex.align-items-center.mb-1
        img(src='@/assets/curso/temas/icono.svg', alt='')
        h3.mb-0.ms-2 #[em Merchandising] de gestión
    ...
    .row.justify-content-center.mb-5(data-aos="zoom-in")
      .col-lg-10.col-sm-12.col-md-12
        ...
        img(src='@/assets/curso/temas/tema1/fig3.png', alt='La figura presenta el contexto de las funciones de la gestión estratégica del merchandising, ilustrado en el gráfico de un supermercado y sus diferentes zonas, y se enumeran a través de puntos calientes, así: 1. El rol de las categorías. 2. La rotación de las categorías. 3. Los tres tiempos de presentación. 4. Los tipos de compra. 5. Los niveles y zonas de presentación. 6. Los tipos y formas de presentación de los productos.')
