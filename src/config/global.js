export default {
  global: {
    ...
    descripcionCurso:
      'Este material de formación explora el impacto que el merchandising genera en el consumidor al considerarse como una sólida estrategia para impulsar las ventas de productos, así como la importancia de la exhibición, las demostraciones y las presentaciones en el punto de ventas, al comprender cómo estas crean un vínculo entre el cliente y el espacio de venta, y permiten que se fomente el impulso y deseo de compra.',
